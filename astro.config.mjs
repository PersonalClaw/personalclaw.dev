...
export default defineConfig({
  ...
  integrations: [
    ...
    starlight({
      ...
      sidebar: [
        // The docs landing (`src/content/docs/docs/index.md`, written by
        // scripts/sync-docs.mjs from src/prose/docs-landing.md). It sits OUTSIDE every
        // autogenerated group, so without this entry it would be a published page the
        // sidebar never linked — reachable only by typing the URL or following the
        // marketing header. Explicit `link`, not an autogenerate group: the docs root
        // holds exactly one page and a group would render an empty folder beside it.
